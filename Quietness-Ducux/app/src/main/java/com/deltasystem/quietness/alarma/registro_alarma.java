    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.change_notification).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mTimePicker = new TimePickerDialog(registro_alarma.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        ...
                        Utils.setAlarm(alarmID, today.getTimeInMillis(), registro_alarma.this);
                    }
